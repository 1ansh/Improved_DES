...
pict = figure('position',[200 200 600 300],'name','Improved DES Based On Irrational Numbers','NumberTitle','off');


text1 = uicontrol(pict,'style','text',...
        'position',[100 265 410 30],'BackgroundColor',[0.80 0.80 0.80],'string','Improved DES Algorithm','FontSize',18);
...
text4 = uicontrol(pict,'style','text',...
        'position',[410 230 150 25],'BackgroundColor',[0.80 0.80 0.80],'string','Decrypted data','FontSize',10);
